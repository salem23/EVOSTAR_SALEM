...
The simple SD driver finished the race without damage, while AD-SSOP was able to complete all the tracks safely except the Dirt1 and Forza circuits, where the damage is also a little high for the AD-SP driver. 
...
Finally, a real race test has been conducted. Our main goal is to test the performance of our best controller, AD-SSOP, in a race, and answer the following questions: Could we have a perfect driving in a race with AD-SSOP only with the track borders sensors? 
