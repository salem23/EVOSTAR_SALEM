...
In E-track5, the controller has win the race because the used track has different curves so the car can follow an optimal path given by the steer module. Furthermore, the target speed sub-controller allowed to go as faster as possible. However, in the Forza track which is characterized by a small width and less curves, the drawbacks of the proposed controller had clearly affected the results.
